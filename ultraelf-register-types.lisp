...
(defparameter *is-register-hash-table-x64* (make-hash-table :test 'equalp))
(setf (gethash "old-8-bit-low-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "old-8-bit-high-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "old-16-bit-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "old-32-bit-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "old-64-bit-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "new-8-bit-low-reg-l" *is-register-hash-table-x64*) "is-register")
(setf (gethash "new-8-bit-low-reg-b" *is-register-hash-table-x64*) "is-register")
(setf (gethash "new-16-bit-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "new-32-bit-reg" *is-register-hash-table-x64*) "is-register")
(setf (gethash "new-64-bit-reg" *is-register-hash-table-x64*) "is-register")
