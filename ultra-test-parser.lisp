...
(defun test-parser ()
  ...
  (rt:deftest |test-create-syntax-tree-foo1-[bar1-bar2]| (create-syntax-tree #a foo [bar1 bar2] #e) (list '("foo1" "[bar1 bar2]")))
  (rt:deftest |test-create-syntax-tree-foo1,[bar1-bar2-bar3]| (create-syntax-tree #a foo [bar1 bar2 bar3] #e) (list '("foo1" "[bar1 bar2 bar3]")))
