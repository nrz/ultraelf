...
(defparameter *create-addressing-form-instances-list*
  (list
    ...
    (list #b000 *reg64-indirect-list-from-rax* 'x86-register-indirect)
    (list #b110 *reg64-indirect-list-from-rsi* 'x86-register-indirect)
    (list #b000 *reg64-indirect-list-from-r8*  'x86-register-indirect)
    (list #b110 *reg64-indirect-list-from-r14* 'x86-register-indirect)))
