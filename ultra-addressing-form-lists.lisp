...
(defparameter *reg-rax-list*               (list "rax"))
(defparameter *reg-rcx-list*               (list "rcx"))
(defparameter *old-reg64-without-rax-rcx-list*          (list "rdx"  "rbx"  "rsp"  "rbp"  "rsi"  "rdi"))
...
(defparameter *create-addressing-form-instances-list*
  (list
    ...
    (list #b000 *reg-rax-list*                         'x86-reg-rax)
    (list #b001 *reg-rcx-list*                         'x86-reg-rcx)
    (list #b010 *old-reg64-without-rax-rcx-list*       'x86-old-64-bits-reg)
